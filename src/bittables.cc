...
constexpr std::array<BitBoard, kNumPositions> BitTables::red_pawn_reverse_moves;
constexpr std::array<BitBoard, kNumPositions> BitTables::black_pawn_moves;
constexpr std::array<BitBoard, kNumPositions>
